...
export const Header = () => {
  return (
    <header className="z-[999] relative flex justify-center  ">
      <motion.div
        className=" w-full h-[4.5rem] fixed top-0 bg-white/80 rounded-none border border-white/40   shadow-lg shadow-black/[0.03]  backdrop-blur-[0.5rem]  sm:top-6 sm:w-[36rem] sm:h-[2.5rem] sm:rounded-full "
        initial={{ y: -20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
      ></motion.div>
      <nav className="fixed top-[0.15rem] py-2  flex h-12 sm:h-[initial] sm:py-0 sm:top-[1.7rem]">
